...
def upgrade() -> None:
    ...
    # Create enum type with checkfirst=True to prevent duplicates
    qualificationlevel = sa.Enum('PRIMARY', 'SECONDARY', 'SUBSTITUTE', name='qualificationlevel')
    qualificationlevel.create(op.get_bind(), checkfirst=True)
    
    op.create_table('teacher_subjects',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('teacher_id', sa.Integer(), nullable=False),
    sa.Column('subject_id', sa.Integer(), nullable=False),
    sa.Column('qualification_level', qualificationlevel, nullable=False),
...
def downgrade() -> None:
    ...
    # Drop enum type
    qualificationlevel = sa.Enum('PRIMARY', 'SECONDARY', 'SUBSTITUTE', name='qualificationlevel')
    qualificationlevel.drop(op.get_bind(), checkfirst=True)
    # ### end Alembic commands ###
